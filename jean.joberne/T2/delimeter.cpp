...
std::istream& jean::operator>>(std::istream& in, Delimeterchar&& exp)
{
...
std::istream& jean::operator>>(std::istream& in, Delimeterstring&& exp)
{
  size_t i = 0;
...
std::istream& jean::operator>>(std::istream& in, Delimeterpair&& exp)
{
  std::istream::sentry guard(in);
  if (guard)
  {
